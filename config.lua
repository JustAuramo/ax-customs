...
vehicleCustomisationPrices = {
    cosmetics = {price = 5.12},
    respray = {price = 1.12},
    performance = {prices = {0, 12.00, 24.00, 36.00, 65.00, 139.00}},
    turbo = {price = 55.81},
    wheels = {price = 2.19},
    customwheels = {price = 4.19},
    wheelsmoke = {price = 1.12},
    windowtint = {price = 4.19},
    neonside = {price = 1.12},
    neoncolours = {price = 1.12},
    headlights = {price = 3.72},
    xenoncolours = {price = 4.72},
    oldlivery = {price = 9.3},
    plateindex = {price = 3.49}
}
